---
description: Generate documentation for output schemas (Output Spec Specialist)
---
...
## Examples
**Example**: `/document-output-spec-specialist schemas/entity.py full`
