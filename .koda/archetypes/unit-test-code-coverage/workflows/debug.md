---
description: Debug workflow for Unit Test Code Coverage archetype (Unit Test Code Coverage)
---
...
Implement debug logic following constitution requirements and best practices for Unit Test Code Coverage.
...
## Error Handling
**Common Issue**: Provide resolution guidance specific to debug and Unit Test Code Coverage.
**Configuration Error**: Validate settings and provide corrections.

## Examples
**Example 1**: `/debug-unit-test-code-coverage Sample scenario` - Output: Expected result for debug operation
**Example 2**: `/debug-unit-test-code-coverage Complex case` - Output: Detailed outcome with recommendations
