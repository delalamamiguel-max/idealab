---
description: Diagnose Isolation Forest Model training, scoring, and deployment issues (Isolation Forest Model)
---
...
- Load `${ARCHETYPES_BASEDIR}/isolation-forest-model/templates/env-config.yaml` for debugging tools
...
## Examples
**Example 1**: `/debug-isolation-forest-model Model convergence issues` - Output: Analysis with hyperparameter recommendations
**Example 2**: `/debug-isolation-forest-model Scoring latency problems` - Output: Performance optimization
