---
description: Document Isolation Forest Model solution for stakeholders and governance (Isolation Forest Model)
---
...
- Load `${ARCHETYPES_BASEDIR}/isolation-forest-model/templates/env-config.yaml` for documentation templates
...
## Examples
**Example 1**: `/document-isolation-forest-model Create model documentation` - Output: Complete documentation package
**Example 2**: `/document-isolation-forest-model Generate governance docs` - Output: Governance-focused documentation
