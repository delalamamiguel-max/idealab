---
description: Refactor workflow for Responsible Prompting archetype (Responsible Prompting)
---
...
Implement refactor logic following constitution requirements and best practices for Responsible Prompting.
...
## Error Handling
**Common Issue**: Provide resolution guidance specific to refactor and Responsible Prompting.
**Configuration Error**: Validate settings and provide corrections.

## Examples
**Example 1**: `/refactor-responsible-prompting Sample scenario` - Output: Expected result for refactor operation
**Example 2**: `/refactor-responsible-prompting Complex case` - Output: Detailed outcome with recommendations
