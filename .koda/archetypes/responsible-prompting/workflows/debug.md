---
description: Debug workflow for Responsible Prompting archetype (Responsible Prompting)
---
...
Implement debug logic following constitution requirements and best practices for Responsible Prompting.
...
## Error Handling
**Common Issue**: Provide resolution guidance specific to debug and Responsible Prompting.
**Configuration Error**: Validate settings and provide corrections.

## Examples
**Example 1**: `/debug-responsible-prompting Sample scenario` - Output: Expected result for debug operation
**Example 2**: `/debug-responsible-prompting Complex case` - Output: Detailed outcome with recommendations
