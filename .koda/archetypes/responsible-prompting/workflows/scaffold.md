---
description: Scaffold workflow for Responsible Prompting archetype (Responsible Prompting)
---
...
Implement scaffold logic following constitution requirements and best practices for Responsible Prompting.
...
## Error Handling
**Common Issue**: Provide resolution guidance specific to scaffold and Responsible Prompting.
**Configuration Error**: Validate settings and provide corrections.

## Examples
**Example 1**: `/scaffold-responsible-prompting Sample scenario` - Output: Expected result for scaffold operation
**Example 2**: `/scaffold-responsible-prompting Complex case` - Output: Detailed outcome with recommendations
