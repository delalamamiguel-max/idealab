---
description: Refactor workflow for Regression Test Coverage archetype (Regression Test Coverage)
---
...
Implement refactor logic following constitution requirements and best practices for Regression Test Coverage.
...
## Error Handling
**Common Issue**: Provide resolution guidance specific to refactor and Regression Test Coverage.
**Configuration Error**: Validate settings and provide corrections.

## Examples
**Example 1**: `/refactor-regression-test-coverage Sample scenario` - Output: Expected result for refactor operation
**Example 2**: `/refactor-regression-test-coverage Complex case` - Output: Detailed outcome with recommendations
