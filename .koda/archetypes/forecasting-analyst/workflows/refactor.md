---
description: Refactor Forecasting Analyst pipeline for compliance, performance, and maintainability (Forecasting Analyst)
---
...
- Load `${ARCHETYPES_BASEDIR}/forecasting-analyst/templates/env-config.yaml` for best practices
...
## Examples
**Example 1**: `/refactor-forecasting-analyst Add governance controls` - Output: Enhanced pipeline with MLflow and fairness
**Example 2**: `/refactor-forecasting-analyst Optimize training performance` - Output: Performance-optimized pipeline
