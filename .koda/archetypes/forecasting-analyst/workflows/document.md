---
description: Document Forecasting Analyst solution for stakeholders and governance (Forecasting Analyst)
---
...
- Load `${ARCHETYPES_BASEDIR}/forecasting-analyst/templates/env-config.yaml` for documentation templates
...
## Examples
**Example 1**: `/document-forecasting-analyst Create model documentation` - Output: Complete documentation package
**Example 2**: `/document-forecasting-analyst Generate governance docs` - Output: Governance-focused documentation
