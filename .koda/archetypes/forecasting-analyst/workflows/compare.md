---
description: Compare Forecasting Analyst approaches and patterns (Forecasting Analyst)
---
...
- Load `${ARCHETYPES_BASEDIR}/forecasting-analyst/templates/env-config.yaml` for comparison framework
...
## Examples
**Example 1**: `/compare-forecasting-analyst Algorithm comparison` - Output: Analysis with recommendations
**Example 2**: `/compare-forecasting-analyst Feature engineering strategies` - Output: Strategy comparison
