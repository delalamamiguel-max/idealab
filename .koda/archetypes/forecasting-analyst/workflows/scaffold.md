---
description: Scaffold governed Forecasting Analyst training pipeline with MLflow tracking and compliance (Forecasting Analyst)
---
...
- Load `${ARCHETYPES_BASEDIR}/forecasting-analyst/templates/env-config.yaml` for configuration
...
## Examples
**Example 1**: `/scaffold-forecasting-analyst Create training pipeline with governance` - Output: Complete ML pipeline with MLflow
**Example 2**: `/scaffold-forecasting-analyst Generate model with fairness checks` - Output: Governed pipeline with fairness validation
