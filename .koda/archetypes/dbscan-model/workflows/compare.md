---
description: Compare Dbscan Model approaches and patterns (Dbscan Model)
---
...
- Load `${ARCHETYPES_BASEDIR}/dbscan-model/templates/env-config.yaml` for comparison framework
...
## Examples
**Example 1**: `/compare-dbscan-model Algorithm comparison` - Output: Analysis with recommendations
**Example 2**: `/compare-dbscan-model Feature engineering strategies` - Output: Strategy comparison
