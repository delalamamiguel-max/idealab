---
description: Scaffold governed Dbscan Model training pipeline with MLflow tracking and compliance (Dbscan Model)
---
...
- Load `${ARCHETYPES_BASEDIR}/dbscan-model/templates/env-config.yaml` for configuration
...
## Examples
**Example 1**: `/scaffold-dbscan-model Create training pipeline with governance` - Output: Complete ML pipeline with MLflow
**Example 2**: `/scaffold-dbscan-model Generate model with fairness checks` - Output: Governed pipeline with fairness validation
