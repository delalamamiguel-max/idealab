---
description: Refactor Dbscan Model pipeline for compliance, performance, and maintainability (Dbscan Model)
---
...
- Load `${ARCHETYPES_BASEDIR}/dbscan-model/templates/env-config.yaml` for best practices
...
## Examples
**Example 1**: `/refactor-dbscan-model Add governance controls` - Output: Enhanced pipeline with MLflow and fairness
**Example 2**: `/refactor-dbscan-model Optimize training performance` - Output: Performance-optimized pipeline
