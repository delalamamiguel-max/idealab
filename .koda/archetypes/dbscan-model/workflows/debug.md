---
description: Diagnose Dbscan Model training, scoring, and deployment issues (Dbscan Model)
---
...
- Load `${ARCHETYPES_BASEDIR}/dbscan-model/templates/env-config.yaml` for debugging tools
...
## Examples
**Example 1**: `/debug-dbscan-model Model convergence issues` - Output: Analysis with hyperparameter recommendations
**Example 2**: `/debug-dbscan-model Scoring latency problems` - Output: Performance optimization
