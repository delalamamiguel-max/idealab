---
description: Document workflow for Software Release Notes archetype (Software Release Notes)
---
...
Implement document logic following constitution requirements and best practices for Software Release Notes.
...
## Error Handling
**Common Issue**: Provide resolution guidance specific to document and Software Release Notes.
**Configuration Error**: Validate settings and provide corrections.

## Examples
**Example 1**: `/document-software-release-notes Sample scenario` - Output: Expected result for document operation
**Example 2**: `/document-software-release-notes Complex case` - Output: Detailed outcome with recommendations
