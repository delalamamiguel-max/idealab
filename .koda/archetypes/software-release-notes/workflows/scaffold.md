---
description: Scaffold workflow for Software Release Notes archetype (Software Release Notes)
---
...
Implement scaffold logic following constitution requirements and best practices for Software Release Notes.
...
## Error Handling
**Common Issue**: Provide resolution guidance specific to scaffold and Software Release Notes.
**Configuration Error**: Validate settings and provide corrections.

## Examples
**Example 1**: `/scaffold-software-release-notes Sample scenario` - Output: Expected result for scaffold operation
**Example 2**: `/scaffold-software-release-notes Complex case` - Output: Detailed outcome with recommendations
