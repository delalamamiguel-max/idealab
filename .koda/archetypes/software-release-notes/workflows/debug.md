---
description: Debug workflow for Software Release Notes archetype (Software Release Notes)
---
...
Implement debug logic following constitution requirements and best practices for Software Release Notes.
...
## Error Handling
**Common Issue**: Provide resolution guidance specific to debug and Software Release Notes.
**Configuration Error**: Validate settings and provide corrections.

## Examples
**Example 1**: `/debug-software-release-notes Sample scenario` - Output: Expected result for debug operation
**Example 2**: `/debug-software-release-notes Complex case` - Output: Detailed outcome with recommendations
