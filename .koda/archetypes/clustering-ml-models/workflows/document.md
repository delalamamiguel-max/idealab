---
description: Document Clustering Ml Models solution for stakeholders and governance (Clustering Ml Models)
---
...
- Load `${ARCHETYPES_BASEDIR}/clustering-ml-models/templates/env-config.yaml` for documentation templates
...
## Examples
**Example 1**: `/document-clustering-ml-models Create model documentation` - Output: Complete documentation package
**Example 2**: `/document-clustering-ml-models Generate governance docs` - Output: Governance-focused documentation
