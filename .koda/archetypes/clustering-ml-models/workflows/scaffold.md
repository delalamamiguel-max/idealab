---
description: Scaffold governed Clustering Ml Models training pipeline with MLflow tracking and compliance (Clustering Ml Models)
---
...
- Load `${ARCHETYPES_BASEDIR}/clustering-ml-models/templates/env-config.yaml` for configuration
...
## Examples
**Example 1**: `/scaffold-clustering-ml-models Create training pipeline with governance` - Output: Complete ML pipeline with MLflow
**Example 2**: `/scaffold-clustering-ml-models Generate model with fairness checks` - Output: Governed pipeline with fairness validation
