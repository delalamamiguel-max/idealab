---
description: Compare Clustering Ml Models approaches and patterns (Clustering Ml Models)
---
...
- Load `${ARCHETYPES_BASEDIR}/clustering-ml-models/templates/env-config.yaml` for comparison framework
...
## Examples
**Example 1**: `/compare-clustering-ml-models Algorithm comparison` - Output: Analysis with recommendations
**Example 2**: `/compare-clustering-ml-models Feature engineering strategies` - Output: Strategy comparison
