---
description: Refactor Clustering Ml Models pipeline for compliance, performance, and maintainability (Clustering Ml Models)
---
...
- Load `${ARCHETYPES_BASEDIR}/clustering-ml-models/templates/env-config.yaml` for best practices
...
## Examples
**Example 1**: `/refactor-clustering-ml-models Add governance controls` - Output: Enhanced pipeline with MLflow and fairness
**Example 2**: `/refactor-clustering-ml-models Optimize training performance` - Output: Performance-optimized pipeline
