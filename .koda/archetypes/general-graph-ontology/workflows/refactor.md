---
description: Refactor workflow for General Graph Ontology archetype (General Graph Ontology)
---
...
Implement refactor logic following constitution requirements and best practices for General Graph Ontology.
...
## Error Handling
**Common Issue**: Provide resolution guidance specific to refactor and General Graph Ontology.
**Configuration Error**: Validate settings and provide corrections.

## Examples
**Example 1**: `/refactor-general-graph-ontology Sample scenario` - Output: Expected result for refactor operation
**Example 2**: `/refactor-general-graph-ontology Complex case` - Output: Detailed outcome with recommendations
