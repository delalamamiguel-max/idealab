---
description: Refactor Q Learning Model pipeline for compliance, performance, and maintainability (Q Learning Model)
---
...
- Load `${ARCHETYPES_BASEDIR}/q-learning-model/templates/env-config.yaml` for best practices
...
## Examples
**Example 1**: `/refactor-q-learning-model Add governance controls` - Output: Enhanced pipeline with MLflow and fairness
**Example 2**: `/refactor-q-learning-model Optimize training performance` - Output: Performance-optimized pipeline
