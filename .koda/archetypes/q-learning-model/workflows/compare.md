---
description: Compare Q Learning Model approaches and patterns (Q Learning Model)
---
...
- Load `${ARCHETYPES_BASEDIR}/q-learning-model/templates/env-config.yaml` for comparison framework
...
## Examples
**Example 1**: `/compare-q-learning-model Algorithm comparison` - Output: Analysis with recommendations
**Example 2**: `/compare-q-learning-model Feature engineering strategies` - Output: Strategy comparison
